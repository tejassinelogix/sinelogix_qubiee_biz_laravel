...
(function (factory) {
    ...
    applyPrecision = function (val, precision) {
      ...
      // var abc = parseInt(val.toFixed(2));
       //alert(abc);
    };
    ...
    Rating.prototype = {
        ...
        _parseAttr: function (vattr, options) {
            ...
            if (elType === 'range' || elType === 'number') {
                ...
                out = parseInt(finalVal);
                  
            } else {
                out = parseInt(options[vattr]);
        ...
        getValueFromPosition: function (pos) {
            ...
            val = applyPrecision(parseInt(self.min + factor * self.step), 2);
        ...
        fetchCaption: function (rating) {
            var self = this, val = parseInt(rating) || self.clearValue, css, cap, capVal, cssVal, caption,
            ...
            return '<span class="' + css + '">' + val + '</span><input type="hidden" name="rating" value='+valtext+'>';
            //return '<span class="' + css + '">' + caption + '</span><input type="hidden" name="rating" value='+caption+'>';
        },
        destroy: function () {
