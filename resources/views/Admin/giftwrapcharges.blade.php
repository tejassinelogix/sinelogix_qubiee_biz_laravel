    ...
    <div class="col-sm-4">
        <div class="page-header float-left">
            <div class="page-title">
                <h1>{{ __('message.Add Gift Box Charges') }}</h1>
            </div>
        </div>
    </div>
    <div class="col-sm-8">
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li class="active">{{ __('message.Add Gift Box Charges') }}</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body card-block">
                        ...
                        @endif
                        <form action="<?php echo url('/admin/updategiftboxprice') ?>" method="post" enctype="multipart/form-data">
                            {{csrf_field()}} 
...
//                                foreach ($users as $produc) {
                                ...
                                <label for="wrapcharges">{{ __('message.Add Gift Box Charges') }} ($)</label><span class="required" style="color: red">*</span>
                                <input type="number" class="form-control quantity" id="wrapcharges" name="wrapcharges" value="<?php echo $users->wraping_charage; ?>" placeholder="">
                                </div>
