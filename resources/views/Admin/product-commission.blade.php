    ...
    <div class="col-sm-4">
        <div class="page-header float-left">
            <div class="page-title">
                <h1>{{ __('message.Product Commission') }}</h1>
            </div>
        </div>
    </div>
    <div class="col-sm-8">
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li class="active">{{ __('message.Product Commission') }}</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">{{ __('message.Product Commission') }}</strong>
                    </div>
                         ...
                         <!--<a href="../admin/exportAllSalesExcel/" class="btn btn-success">{{ __('message.Export To Excel') }}</a>-->
                           ...
                           <!--<a href="../admin/exportAllSalesExcel/" class="btn btn-success">{{ __('message.Export To Excel') }}</a>-->
                            <?php //}?>
                         <a href="../admin/productcommissvenpdf/" class="btn btn-primary">{{ __('message.Export To Pdf') }}</a>
                          <a href="../admin/productcommissionprint/" class="btn btn-info btnprint">Print Preview</a>
                            ...
                            <tbody>
                                ...
                                foreach ($research as $researchdata) {
                                   ...
                                   <?php  } ?> 
                                    ...
                                    <center>
                        <br><br>
                        <a href="{{ url('../admin/productidcommission') }}/<?php echo $researchdata->product_id; ?>" class="btn btn-info btnprint">Print Preview</a></center>
                                        </td>
