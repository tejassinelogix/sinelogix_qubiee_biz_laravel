            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        ...
                        <li class="active">{{ __('message.All Reviews') }}</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ __('message.Product Id') }}</th>
                                         <?php }?>
                                        <th>{{ __('message.Product Name') }}</th>
                                        <!--<th>Vendor Name</th>-->
                                        <th><center>{{ __('message.Number Of Reviews') }}</center></th>
                                        <th><center>{{ __('message.Avarage') }}</center></th>
                                        <?php //if(Auth::user()->job_title == 'superadmin'){ ?>
                                        <!--<th>Username Name</th>-->
                                        <?php //} ?>
<!--                                        <th>Comment</th>
                                ...
                                foreach ($productReviews as $researchdata) {
                                   ?> 
                                    ...
                                    <?php echo $researchdata->total; ?> 
                                        ...
                                        <td><center><span class="badge badge-success"><?php echo round($researchdata->rating,2)?> / 5.00 </span>
...
<!--                                                <a href="edit-product.html" data-toggle="tooltip" title="Edit">
                                                ...
                                                <a href="viewreviews/{{$researchdata->product_id}}" data-toggle="tooltip" title="View">
                                                    <i class="fa fa-eye"></i>
                                                </a>
<!--
