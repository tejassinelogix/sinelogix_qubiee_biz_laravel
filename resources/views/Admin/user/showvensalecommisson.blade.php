                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        // if( $usertype == 'superadmin') { ?>
                         <!--<a href="../exportVenodrCommExcel/<?php echo $id;?>" class="btn btn-success">{{ __('message.Export To Excel') }}</a>-->
                            <?php //} else{ ?>
                         
                           <!--<a href="../exportVenodrCommExcel/<?php echo $id;?>" class="btn btn-success">{{ __('message.Export To Excel') }}</a>-->
                            <?php //}?>
                           <a href="../exportVenodrCommPdf/<?php echo $id;?>" class="btn btn-primary">{{ __('message.Export To Pdf') }}</a>
                          <a href="../prnprivenodrcommview/<?php echo $id;?>" class="btn btn-info btnprint">Print Preview</a>
                                         ...
                                         <?php 
                                          foreach ($user as $userrate){
                                           if($userrate->admin_id == $researchdata->role_id){ ?>
                                              ...
                                              if($researchdata->productpriceitem <= 100){
                                              $commissionprice = $researchdata->productpriceitem - ($researchdata->productpriceitem * ($userrate->lesshundred / 100));       
                                            $commissionprice=   $researchdata->productpriceitem - $commissionprice;
                                              }else{
                                                  $commissionprice = $researchdata->productpriceitem - ($researchdata->productpriceitem * ($userrate->greterhundred / 100)); 
                                             $commissionprice=   $researchdata->productpriceitem - $commissionprice;
                                                  }
                                               echo '$'. $commissionprice=$researchdata->total*$commissionprice;
                                               $productpricesum+=$commissionprice;
...
<!--                                        <center>
                                    ...
                                    <center>
                        <br><br>
                        <a href="{{ url('../admin/prnprivencomm') }}/<?php echo $researchdata->role_id; ?>/<?php echo $researchdata->order_id; ?>" class="btn btn-info btnprint">Print Preview</a></center>
                                        </td>
