...
<!--                                                <div class="card-header">
                    ...
                    <div align="center">    
                        <a href="../showvenpaytranpdf/<?php echo $id; ?>" class="btn btn-primary">{{ __('message.Export To Pdf') }}</a>
                          <a href="../showvenpaytranprint/<?php echo $id; ?>" class="btn btn-info btnprint">Print Preview</a>
                ...
                $('.btnprint').printPage();
                    ...
                    @if (\Session::has('success'))
                        ...
                        @if ($errors->any())
                                    ...
                                    @endif
                    <form role="form" action="<?php echo url('/admin/addtransaction') ?>" method="post">
            {{ csrf_field() }}
           <div class="box-body">
              <div class="col-lg-offset-3 col-lg-6">
                  ...
                  <label for="Rate">Pay Amount</label>
                  <input type="number" class="form-control" id="payedamount" name="payedamount" placeholder="Pay Amount" value="{{ old('payedamount') }}">
