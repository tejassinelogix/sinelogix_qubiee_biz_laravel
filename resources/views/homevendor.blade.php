        ...
        <div class="col-sm-4">
            <div class="page-header float-left">
                <div class="page-title">
                    <a href="{{ route('admin.home')}}"><h1>Dashboard</h1></a>
                </div>
            </div>
        </div>
        <div class="col-sm-8">
    ...
    <div class="content mt-3">
        ...
        <div class="col-sm-6 col-lg-3">
            <a href="{{ url("/admin/allproduct/") }}" class="dashboardBlocks">
                <div class="dashboardBlockTitle"><p>Product</p></div>
        ...
        <div class="col-sm-6 col-lg-3">
            <a href="<?php echo url('/admin/allmenu') ?>" class="dashboardBlocks">
                <div class="dashboardBlockTitle"><p>Category</p></div>
       ...
       @can('products.users',Auth::user())
        ...
        <div class="col-sm-6 col-lg-3">
            <a href="{{ route('user.index') }}" class="dashboardBlocks">
                <div class="dashboardBlockTitle"><p>Users</p></div>
...
@can('products.roles',Auth::user())
        ...
        <div class="col-sm-6 col-lg-3">
            <a href="{{ route('role.index') }}" class="dashboardBlocks">
                <div class="dashboardBlockTitle"><p>Roles</p></div>
