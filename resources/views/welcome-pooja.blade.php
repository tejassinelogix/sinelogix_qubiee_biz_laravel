...
<!--                                <ul class="ratings">
                                ...
                                <span class="services-btns">
                                    <a href="<?php echo url('index/productdetails'); ?>/{{$newproductfullname }}" class="addtocart-btn">
                                        View Details</a>
                                        <a class="btn btn-danger" href='{{ url("/add-to-cart/{$newproduct->id}") }}'>Add To Cart</a>
                            ...
                            <div class="productDisc">
                                ...
                                <span class="services-btns">
                                    ...
                                    <a href="<?php echo url('index/productdetails'); ?>/{{$offproductfullname }}" class="addtocart-btn">
                                        View Details</a>
                                         <a class="btn btn-danger" href='{{ url("/add-to-cart/{$offerproduct->id}") }}'>Add To Cart</a>
<!--                                    <a href="#" class="addtocart-btn">Live Demo&nbsp;
                                    </a>-->
                                </span>
                            </div>
...
<!--                            <ul class="ratings">
                            ...
                            <br>
                            <strong class="ServiceCost"><strike>{{ $featureproduct->original_price }}</strike></strong>
                            <span class="services-btns">
                                <a href="<?php echo url('index/productdetails'); ?>/{{$productfullname }}" class="addtocart-btn">
                                    View Details</a>
                                <a class="btn btn-danger" href='{{ url("/add-to-cart/{$featureproduct->id}") }}'>Add To Cart</a>
<!--                                <a href="#" class="addtocart-btn">Live Demo&nbsp;
                                </a>-->
                            </span>
                        </div>
